...
require "component.com.smallgames.GirlLuckyPlate"

Slot = Slot or {}

Slot.modules = Slot.modules or {}

Slot.modules.GirlLuckyPlatePage = Slot.pages.Page:extend({

    __className = "Slot.modules.GirlLuckyPlatePage",
    ...
    --        self.rootNode:addChild(self.tip,1)
        ...
        self._slotManager = Slot.com.GirlLuckyPlate:new({
