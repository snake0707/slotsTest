...
-- by bbf
cc.LEVER_ASSETSMANAGER_CREATE_FILE  = 0
cc.LEVER_ASSETSMANAGER_NETWORK = 1
cc.LEVER_ASSETSMANAGER_NO_NEW_VERSION = 2
cc.LEVER_ASSETSMANAGER_UNCOMPRESS     = 3

cc.LEVER_ASSETSMANAGER_PROTOCOL_PROGRESS =  0
cc.LEVER_ASSETSMANAGER_PROTOCOL_SUCCESS  =  1
cc.LEVER_ASSETSMANAGER_PROTOCOL_ERROR    =  2
...
-- by bbf
cc.Handler.LEVER_ASSETSMANAGER_PROGRESS = 64
cc.Handler.LEVER_ASSETSMANAGER_SUCCESS  = 65
cc.Handler.LEVER_ASSETSMANAGER_ERROR    = 66
